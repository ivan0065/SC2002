...
public class AppManager {
    private ProjectDatabase projectDatabase; // Database of BTO projects and users
    ...
    private ReceiptGenerator receiptGenerator; // To generate receipts
    ...
    public void bookFlat(HDBOfficer officer, String applicationId) {
        ...
        if (application.bookFlat(officer.getUserID())) {
            ...
            Applicant applicant = getApplicantByNRIC(application.getApplicantId());
            if (applicant != null) {
                receiptGenerator.generateReceipt(applicant, application, project);
            } else {
                System.out.println("Applicant not found for application: " + applicationId);
            }
        }
    }
